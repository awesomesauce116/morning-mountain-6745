...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/morning-mountain-6745#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/morning-mountain-6745
```

A live public deployment of this template is available at [https://morning-mountain-6745.templates.workers.dev](https://morning-mountain-6745.templates.workers.dev)
